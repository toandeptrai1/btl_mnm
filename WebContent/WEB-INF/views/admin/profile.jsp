              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">${userEdit.user_fullname }</div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">${userEdit.user_address }</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8">${userEdit.user_phone }</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Email</div>
                    <div class="col-lg-9 col-md-8">${userEdit.user_email }</div>
                  </div>
                  ...
                  <form method="post" action="/JewelryShop/quan-tri/user/edit">
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<%=request.getContextPath()%>/assets/admin/assets/img/profile-img.jpg" alt="Profile">
                        <div class="pt-2">
